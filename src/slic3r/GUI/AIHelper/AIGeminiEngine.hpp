#ifndef slic3r_AIGeminiEngine_hpp_
#define slic3r_AIGeminiEngine_hpp_

#include "AIEngine.hpp"

namespace Slic3r {

class AIGeminiEngine : public AIEngineBase
{
public:
    explicit AIGeminiEngine(const std::string& api_key = "",
                            const std::string& model = "gemini-2.5-flash",
                            const std::string& endpoint = "");

    std::string get_backend_name() const override { return "gemini"; }
...
#endif // slic3r_AIGeminiEngine_hpp_